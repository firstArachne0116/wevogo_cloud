                ...
                <div class="row m-b">
                    <div class="col-md-6">
                        <div class="form-group {!! $errors->first('sn', 'has-error') !!}">
                            {!! Form::label('SN') !!}
                            {!! Form::text('sn', old('sn'), array('class'=>'form-control')) !!}
                            @if ($errors->has('sn'))
                                <span class="help-block">
                    ...
                    <div class="col-md-6">
                        <div class="form-group {!! $errors->first('mac_address', 'has-error') !!}">
                            ...
                            {!! Form::text('mac_address', old('mac_address'), array('class'=>'form-control')) !!}
